...
FILE_PATH = "D:/14K BIG DATA COURSE/Kafka/Kafkacode/Confluent-Kafka-Setup/cardekho_dataset.csv"
columns=['car_name', 'brand', 'model', 'vehicle_age', 'km_driven', 'seller_type',
       'fuel_type', 'transmission_type', 'mileage', 'engine', 'max_power',
       'seats', 'selling_price']

API_KEY = 'HTQ6KQCG7YE7NY2P'
ENDPOINT_SCHEMA_URL  = 'https://psrc-qjmzd.us-east-2.aws.confluent.cloud'
API_SECRET_KEY = 'SHy8+hS0+aTXG/NggluxRN6g722FFG+LXTZSfFcHXwNXomt0KHOEiMPDABXLAYlD'
BOOTSTRAP_SERVER = 'pkc-6ojv2.us-west4.gcp.confluent.cloud:9092'
SECURITY_PROTOCOL = 'SASL_SSL'
SSL_MACHENISM = 'PLAIN'
SCHEMA_REGISTRY_API_KEY = 'M4PZLMJNYJMMLRHW'
SCHEMA_REGISTRY_API_SECRET = 'PZGuEDpmnWSNQzhYa/9MvRk7ocwapd3gVXooiSfyVKuJnfwUUAgbw9W4skynBhkm'
...
#used to connect to schema registry 
def schema_config():
